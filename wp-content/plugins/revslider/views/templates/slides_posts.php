	<div class="wrap settings_wrap">
		...
		<?php _e("The slides are posts that taken from multiple sources.",REVSLIDER_TEXTDOMAIN)?> &nbsp;
	...
	<script type="text/javascript">
		...
		var g_messageDeleteSlide = "<?php _e("Delete this post?",REVSLIDER_TEXTDOMAIN)?>";
