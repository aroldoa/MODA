...
<div class="col2-set checkout" id="customer_login">

	<div class="col-1 eight columns alpha">

<?php endif; ?>

		<h3 class="spb_headingLeft noleftspace"><span><?php _e( 'Login', 'woocommerce' ); ?></span></h3>
		<form method="post" class="accountlogin">
			<p class="form-row form-row-first">
				<label for="username"><?php _e( 'Username or email', 'woocommerce' ); ?> <span class="required">*</span></label>
				<input type="text" class="input-text email-acct" name="username" id="username" />
			</p>
			<p class="form-row form-row-last">
				<label for="password"><?php _e( 'Password', 'woocommerce' ); ?> <span class="required">*</span></label>
				<input class="input-text pass-acct" type="password" name="password" id="password" />
			</p>
			<div class="clear"></div>
...
<?php if (get_option('woocommerce_enable_myaccount_registration')=='yes') : ?>
	...
	<div class="col-2 seven columns omega offset-by-one">

		<h3 class="spb_headingLeft noleftspace"><span><?php _e( 'Register', 'woocommerce' ); ?></span></h3>
