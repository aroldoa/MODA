...
<div class="twelve columns alpha cartpage">
	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="button black" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-button button alt cyan" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
		...
		<h3 class="spb_headingLeft noleftspace"><span>Have a Promo Code?</span></h3>
			...
			<div class="coupon">
					...
					<div class="coupon">
						...
						<input name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="button black" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
