...
<?php if ( $woocommerce->cart->ship_to_billing_address_only() && $woocommerce->cart->needs_shipping() ) : ?>
	...
	<h3 class="spb_headingLeft noleftspace"><span><?php _e( 'Billing &amp; Shipping', 'woocommerce' ); ?></span></h3>

<?php else : ?>

	<h3 class="spb_headingLeft noleftspace"><span><?php _e( 'Billing Address', 'woocommerce' ); ?></span></h3>
